...
let test_property_update () =
  ...
  let redex_light = create_node ~props:["power", Bool true] ~name:"light1" ~node_type:"Light" 20 ctl_light in
  ...
  let react_light = create_node ~props:["power", Bool false] ~name:"light1" ~node_type:"Light" 30 ctl_light in
  ...
  let target_light = create_node ~props:["power", Bool true] ~name:"light1" ~node_type:"Light" 2 ctl_light in
