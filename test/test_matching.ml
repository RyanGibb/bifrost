...
let test_property_update () =
  ...
  let redex_light, redex_bg =
    create_node_with_uid
      ~props:[ ("power", Bool true) ]
      "light1" 20 ctl_light redex_bg
  in
  let redex_place =
    {
      redex_bg.place with
  ...
  let react_light, reactum_bg =
    create_node_with_uid
      ~props:[ ("power", Bool false) ]
      "light1" 30 ctl_light reactum_bg
  in
  let reactum_place =
    {
  ...
  let target_light, target_bg =
    create_node_with_uid
      ~props:[ ("power", Bool true) ]
      "light1" 2 ctl_light target_bg
  in
  let target_place =
    {
