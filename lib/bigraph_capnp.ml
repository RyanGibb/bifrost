  ...
  module Reader = struct
    ...
    module PropertyValue = struct
      ...
      module ColorVal = struct
        ...
        type t = struct_t reader_t
        let r_get x =
          RA_.get_uint8 ~default:0 x 4
        let g_get x =
          RA_.get_uint8 ~default:0 x 5
        let b_get x =
          RA_.get_uint8 ~default:0 x 6
    ...
    module Node = struct
      ...
      let has_properties x =
        RA_.has_field x 2
      let properties_get x = 
        RA_.get_struct_list x 2
      let properties_get_list x =
  ...
  module Builder = struct
    ...
    module PropertyValue = struct
      ...
      module ColorVal = struct
        ...
        type t = struct_t builder_t
        let r_get x =
          BA_.get_uint8 ~default:0 x 4
        let r_set_exn x v =
          BA_.set_uint8 ~default:0 x 4 v
        let g_get x =
          BA_.get_uint8 ~default:0 x 5
        let g_set_exn x v =
          BA_.set_uint8 ~default:0 x 5 v
        let b_get x =
      ...
      let bool_val_set x v =
        BA_.set_bit ~discr:{BA_.Discr.value=0; BA_.Discr.byte_ofs=2} ~default:false x ~byte_ofs:0 ~bit_ofs:0 v
      let int_val_get x =
      ...
      let string_val_set x v =
        BA_.set_text ~discr:{BA_.Discr.value=3; BA_.Discr.byte_ofs=2} x 0 v
