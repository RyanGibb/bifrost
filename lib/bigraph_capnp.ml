...
module MakeRPC (MessageWrapper : Capnp.RPC.S) = struct
  ...
  module Reader = struct
    ...
    module PropertyValue = struct
      ...
      let float_val_get x = RA_.get_float32 ~default_bits:0l x 4
    ...
    module Node = struct
      ...
      let has_name x = RA_.has_field x 3
      let name_get x = RA_.get_text ~default:"" x 3
      let has_type x = RA_.has_field x 4
      let type_get x = RA_.get_text ~default:"" x 4
      let of_message x = RA_.get_root_struct (RA_.Message.readonly x)
      let of_builder x = Some (RA_.StructStorage.readonly x)
    end
  ...
  module Builder = struct
    ...
    module PropertyValue = struct
      ...
      let float_val_get x = BA_.get_float32 ~default_bits:0l x 4
    ...
    module Property = struct
      ...
      let value_get x = BA_.get_struct ~data_words:1 ~pointer_words:1 x 1
      ...
      let value_init x = BA_.init_struct ~data_words:1 ~pointer_words:1 x 1
    ...
    module Node = struct
      ...
      let has_name x = BA_.has_field x 3
      let name_get x = BA_.get_text ~default:"" x 3
      let name_set x v = BA_.set_text x 3 v
      let has_type x = BA_.has_field x 4
      let type_get x = BA_.get_text ~default:"" x 4
      let type_set x v = BA_.set_text x 4 v
    ...
    module Bigraph = struct
      ...
      let nodes_get x = BA_.get_struct_list ~data_words:2 ~pointer_words:5 x 0
      let nodes_get_list x = Capnp.Array.to_list (nodes_get x)
      let nodes_get_array x = Capnp.Array.to_array (nodes_get x)
    ...
    module Rule = struct
      ...
      let redex_get x = BA_.get_struct ~data_words:1 ~pointer_words:2 x 1
      ...
      let redex_init x = BA_.init_struct ~data_words:1 ~pointer_words:2 x 1
      let has_reactum x = BA_.has_field x 2
      let reactum_get x = BA_.get_struct ~data_words:1 ~pointer_words:2 x 2
      ...
      let reactum_init x = BA_.init_struct ~data_words:1 ~pointer_words:2 x 2
